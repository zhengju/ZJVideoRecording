...
@implementation ZJAssetWriteManager

#pragma mark - private method
- (void)setUpInitWithType:(ZJVideoViewType )type
{
    switch (type) {
        case Type1X1:
...
- (void)appendSampleBuffer:(CMSampleBufferRef)sampleBuffer ofMediaType:(NSString *)mediaType
{
    ...
    @synchronized(self){
        if (self.writeState < ZJRecordStateRecording){
            NSLog(@"not ready yet");
            return;
        }
    }
...
- (void)startWrite
{
    self.writeState = ZJRecordStatePrepareRecording;
    if (!self.assetWriter) {
        [self setUpWriter];
    }
...
- (void)stopWrite
{
    self.writeState = ZJRecordStateFinish;
...
- (void)setUpWriter
{
    ...
    self.writeState = ZJRecordStateRecording;
