...
@interface ZJPhotograph()<AVCapturePhotoCaptureDelegate,ZJPhotographBottomViewDelegate,ZJPhotographTopViewDelegate>
...
@property(strong,nonatomic) ZJPhotographBottomView * bottomView;
@property(strong,nonatomic) ZJPhotographTopView * topView;
@end



@implementation ZJPhotograph
...
- (void)viewDidLoad {
    ...
    self.bottomView = [[ZJPhotographBottomView alloc]init];
    self.bottomView.delegate = self;
    [self.view addSubview:self.bottomView];
    self.topView = [[ZJPhotographTopView alloc]init];
...
- (void)takeButtonClick{
    ...
    [self.capturePhotoOutput capturePhotoWithSettings:self.photoSettings delegate:self];
}
#pragma mark 切换前后摄像头
...
#pragma mark -- ZJPhotographBottomViewDelegate
- (void)photographAction{
    [self takeButtonClick];
}
#pragma  mark -- ZJPhotographTopViewDelegate
- (void)switchAction{
    [self toggleButtonClick];
}
@end
